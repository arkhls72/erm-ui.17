...
describe('Province routing resolve service', () => {
  ...
  let resultProvince: Province | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Province returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Province>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
