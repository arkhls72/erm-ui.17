...
describe('ServiceType Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'service-type', component: ServiceTypeComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to serviceTypeService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getServiceTypeIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getServiceTypeIdentifier).toHaveBeenCalledWith(entity);
