...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../service-type.test-samples';

import { ServiceTypeService } from './service-type.service';

const requireRestSample: ServiceType = {
...
describe('ServiceType Service', () => {
  ...
  let expectedResult: ServiceType | ServiceType[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    it('should create a ServiceType', () => {
      const serviceType = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(serviceType).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a ServiceType', () => {
      const serviceType = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(serviceType).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addServiceTypeToCollectionIfMissing', () => {
      it('should add a ServiceType to an empty array', () => {
        const serviceType: ServiceType = sampleWithRequiredData;
      ...
      it('should not add a ServiceType to an array that contains it', () => {
        const serviceType: ServiceType = sampleWithRequiredData;
        const serviceTypeCollection: ServiceType[] = [
          {
            ...serviceType,
          },
      ...
      it("should add a ServiceType to an array that doesn't contain it", () => {
        const serviceType: ServiceType = sampleWithRequiredData;
        const serviceTypeCollection: ServiceType[] = [sampleWithPartialData];
        expectedResult = service.addServiceTypeToCollectionIfMissing(serviceTypeCollection, serviceType);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(serviceType);
      });
      ...
      it('should add only unique ServiceType to an array', () => {
        const serviceTypeArray: ServiceType[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const serviceTypeCollection: ServiceType[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const serviceType: ServiceType = sampleWithRequiredData;
        const serviceType2: ServiceType = sampleWithPartialData;
    ...
    describe('compareServiceType', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareServiceType(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareServiceType(entity1, entity2);
        const compareResult2 = service.compareServiceType(entity2, entity1);
