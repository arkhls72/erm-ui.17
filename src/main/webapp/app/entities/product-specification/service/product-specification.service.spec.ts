...
import { ProductSpecificationService, RestProductSpecification } from './product-specification.service';

const requireRestSample: RestProductSpecification = {
  ...sampleWithRequiredData,
...
describe('ProductSpecification Service', () => {
  ...
  let expectedResult: ProductSpecification | ProductSpecification[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addProductSpecificationToCollectionIfMissing', () => {
      it('should add a ProductSpecification to an empty array', () => {
        const productSpecification: ProductSpecification = sampleWithRequiredData;
      ...
      it('should not add a ProductSpecification to an array that contains it', () => {
        const productSpecification: ProductSpecification = sampleWithRequiredData;
        const productSpecificationCollection: ProductSpecification[] = [
          {
      ...
      it("should add a ProductSpecification to an array that doesn't contain it", () => {
        const productSpecification: ProductSpecification = sampleWithRequiredData;
        const productSpecificationCollection: ProductSpecification[] = [sampleWithPartialData];
        expectedResult = service.addProductSpecificationToCollectionIfMissing(productSpecificationCollection, productSpecification);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(productSpecification);
      });
      ...
      it('should add only unique ProductSpecification to an array', () => {
        const productSpecificationArray: ProductSpecification[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const productSpecificationCollection: ProductSpecification[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const productSpecification: ProductSpecification = sampleWithRequiredData;
        const productSpecification2: ProductSpecification = sampleWithPartialData;
