...
export class OrderComponent implements OnInit {
  ...
  trackId = (_index: number, item: Order): number => this.orderService.getOrderIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: Order[] | null): Order[] {
    return data ?? [];
  }
