...
describe('Order routing resolve service', () => {
  ...
  let resultOrder: Order | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Order returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Order>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
