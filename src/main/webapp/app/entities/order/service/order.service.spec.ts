...
describe('Order Service', () => {
  ...
  let expectedResult: Order | Order[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addOrderToCollectionIfMissing', () => {
      it('should add a Order to an empty array', () => {
        const order: Order = sampleWithRequiredData;
      ...
      it("should add a Order to an array that doesn't contain it", () => {
        const order: Order = sampleWithRequiredData;
        const orderCollection: Order[] = [sampleWithPartialData];
        expectedResult = service.addOrderToCollectionIfMissing(orderCollection, order);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(order);
      });
      ...
      it('should add only unique Order to an array', () => {
        const orderArray: Order[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const orderCollection: Order[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const order: Order = sampleWithRequiredData;
        const order2: Order = sampleWithPartialData;
