...
describe('Exercise Form Service', () => {
  ...
  describe('Service methods', () => {
    describe('createExerciseFormGroup', () => {
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            bodyPartId: expect.any(Object),
            muscle: expect.any(Object),
            typeId: expect.any(Object),
            positionId: expect.any(Object),
            movementId: expect.any(Object),
            toolId: expect.any(Object),
            mediaId: expect.any(Object),
            description: expect.any(Object),
            firstMediaId: expect.any(Object),
            secondMediaId: expect.any(Object),
      ...
      it('passing Exercise should create a new form with FormGroup', () => {
    ...
    describe('resetForm', () => {
      it('passing Exercise should not enable id FormControl', () => {
        const formGroup = service.createExerciseFormGroup();
