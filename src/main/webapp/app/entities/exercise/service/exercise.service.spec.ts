...
describe('Exercise Service', () => {
  ...
  let expectedResult: Exercise | Exercise[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addExerciseToCollectionIfMissing', () => {
      it('should add a Exercise to an empty array', () => {
        const exercise: Exercise = sampleWithRequiredData;
      ...
      it("should add a Exercise to an array that doesn't contain it", () => {
        const exercise: Exercise = sampleWithRequiredData;
        const exerciseCollection: Exercise[] = [sampleWithPartialData];
        expectedResult = service.addExerciseToCollectionIfMissing(exerciseCollection, exercise);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(exercise);
      });
      ...
      it('should add only unique Exercise to an array', () => {
        const exerciseArray: Exercise[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const exerciseCollection: Exercise[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const exercise: Exercise = sampleWithRequiredData;
        const exercise2: Exercise = sampleWithPartialData;
