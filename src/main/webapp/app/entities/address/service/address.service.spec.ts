...
describe('Address Service', () => {
  ...
  let expectedResult: Address | Address[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addAddressToCollectionIfMissing', () => {
      it('should add a Address to an empty array', () => {
        const address: Address = sampleWithRequiredData;
      ...
      it("should add a Address to an array that doesn't contain it", () => {
        const address: Address = sampleWithRequiredData;
        const addressCollection: Address[] = [sampleWithPartialData];
        expectedResult = service.addAddressToCollectionIfMissing(addressCollection, address);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(address);
      });
      ...
      it('should add only unique Address to an array', () => {
        const addressArray: Address[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const addressCollection: Address[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const address: Address = sampleWithRequiredData;
        const address2: Address = sampleWithPartialData;
