...
describe('Address routing resolve service', () => {
  ...
  let resultAddress: Address | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Address returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Address>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
