...
describe('Plan Service', () => {
  ...
  let expectedResult: Plan | Plan[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addPlanToCollectionIfMissing', () => {
      it('should add a Plan to an empty array', () => {
        const plan: Plan = sampleWithRequiredData;
      ...
      it("should add a Plan to an array that doesn't contain it", () => {
        const plan: Plan = sampleWithRequiredData;
        const planCollection: Plan[] = [sampleWithPartialData];
        expectedResult = service.addPlanToCollectionIfMissing(planCollection, plan);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(plan);
      });
      ...
      it('should add only unique Plan to an array', () => {
        const planArray: Plan[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const planCollection: Plan[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const plan: Plan = sampleWithRequiredData;
        const plan2: Plan = sampleWithPartialData;
