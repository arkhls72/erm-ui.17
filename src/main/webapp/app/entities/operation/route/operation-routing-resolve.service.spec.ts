...
describe('Operation routing resolve service', () => {
  ...
  let resultOperation: Operation | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Operation returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Operation>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
