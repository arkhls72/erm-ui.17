...
const requireRestSample: RestOperation = {
  ...
  operationDate: sampleWithRequiredData.operationDate?.toJSON(),
...
describe('Operation Service', () => {
  ...
  let expectedResult: Operation | Operation[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addOperationToCollectionIfMissing', () => {
      it('should add a Operation to an empty array', () => {
        const operation: Operation = sampleWithRequiredData;
      ...
      it('should not add a Operation to an array that contains it', () => {
        const operation: Operation = sampleWithRequiredData;
        const operationCollection: Operation[] = [
          {
            ...operation,
          },
      ...
      it("should add a Operation to an array that doesn't contain it", () => {
        const operation: Operation = sampleWithRequiredData;
        const operationCollection: Operation[] = [sampleWithPartialData];
        expectedResult = service.addOperationToCollectionIfMissing(operationCollection, operation);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(operation);
      });
      ...
      it('should add only unique Operation to an array', () => {
        const operationArray: Operation[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const operationCollection: Operation[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const operation: Operation = sampleWithRequiredData;
        const operation2: Operation = sampleWithPartialData;
