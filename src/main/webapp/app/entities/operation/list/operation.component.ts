...
export class OperationComponent implements OnInit {
  ...
  trackId = (_index: number, item: Operation): number => this.operationService.getOperationIdentifier(item);
  ...
  protected refineData(data: Operation[]): Operation[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: Operation[] | null): Operation[] {
    return data ?? [];
  }
