...
describe('Product Form Service', () => {
  ...
  describe('Service methods', () => {
      ...
      it('should create a new form with FormControl', () => {
        ...
        expect(formGroup.controls).toEqual(
          expect.objectContaining({
            ...
            emptyPrice: expect.any(Object),
          }),
        );
      });

      it('passing Product should create a new form with FormGroup', () => {
    ...
    describe('resetForm', () => {
      it('passing Product should not enable id FormControl', () => {
        const formGroup = service.createProductFormGroup();
