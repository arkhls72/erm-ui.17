...
describe('Product routing resolve service', () => {
  ...
  let resultProduct: Product | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Product returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Product>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
