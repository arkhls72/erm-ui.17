...
export class ProductComponent implements OnInit {
  ...
  trackId = (_index: number, item: Product): number => this.productService.getProductIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: Product[] | null): Product[] {
    return data ?? [];
  }
