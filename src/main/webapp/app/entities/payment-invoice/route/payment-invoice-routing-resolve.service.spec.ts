...
import paymentInvoiceResolve from './payment-invoice-routing-resolve.service';

describe('PaymentInvoice routing resolve service', () => {
  let mockRouter: Router;
  let mockActivatedRouteSnapshot: ActivatedRouteSnapshot;
  let service: PaymentInvoiceService;
  let resultPaymentInvoice: PaymentInvoice | null | undefined;
  ...
  describe('resolve', () => {
    it('should return PaymentInvoice returned by find', () => {
      // GIVEN
      ...
      TestBed.runInInjectionContext(() => {
        paymentInvoiceResolve(mockActivatedRouteSnapshot).subscribe({
          next(result) {
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<PaymentInvoice>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
