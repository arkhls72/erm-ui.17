...
describe('Countries routing resolve service', () => {
  ...
  let resultCountries: Countries | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Countries returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Countries>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
