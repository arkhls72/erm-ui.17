...
export class InstructionComponent implements OnInit {
  ...
  trackId = (_index: number, item: Instruction): number => this.instructionService.getInstructionIdentifier(item);

  ngOnInit(): void {
    this.load();
  }

  delete(instruction: Instruction): void {
  ...
  protected fillComponentAttributesFromResponseBody(data: Instruction[] | null): Instruction[] {
    return data ?? [];
  }
