...
describe('Instruction Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'instruction', component: InstructionComponent }]),
      ...
      .overrideTemplate(InstructionComponent, '')
      .compileComponents();
  ...
  describe('trackId', () => {
    it('Should forward to instructionService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getInstructionIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getInstructionIdentifier).toHaveBeenCalledWith(entity);
