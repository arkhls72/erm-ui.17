...
export class PositionComponent implements OnInit {
  ...
  trackId = (_index: number, item: Position): number => this.positionService.getPositionIdentifier(item);
  ...
  protected refineData(data: Position[]): Position[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: Position[] | null): Position[] {
    return data ?? [];
  }
