...
describe('ProductOrder Service', () => {
  ...
  let expectedResult: ProductOrder | ProductOrder[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addProductOrderToCollectionIfMissing', () => {
      it('should add a ProductOrder to an empty array', () => {
        const productOrder: ProductOrder = sampleWithRequiredData;
      ...
      it('should not add a ProductOrder to an array that contains it', () => {
        const productOrder: ProductOrder = sampleWithRequiredData;
        const productOrderCollection: ProductOrder[] = [
          {
            ...productOrder,
          },
      ...
      it("should add a ProductOrder to an array that doesn't contain it", () => {
        const productOrder: ProductOrder = sampleWithRequiredData;
        const productOrderCollection: ProductOrder[] = [sampleWithPartialData];
        expectedResult = service.addProductOrderToCollectionIfMissing(productOrderCollection, productOrder);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(productOrder);
      });
      ...
      it('should add only unique ProductOrder to an array', () => {
        const productOrderArray: ProductOrder[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const productOrderCollection: ProductOrder[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const productOrder: ProductOrder = sampleWithRequiredData;
        const productOrder2: ProductOrder = sampleWithPartialData;
