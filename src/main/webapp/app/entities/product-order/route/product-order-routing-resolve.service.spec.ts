...
describe('ProductOrder routing resolve service', () => {
  ...
  let resultProductOrder: ProductOrder | null | undefined;
  ...
  describe('resolve', () => {
    it('should return ProductOrder returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<ProductOrder>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
