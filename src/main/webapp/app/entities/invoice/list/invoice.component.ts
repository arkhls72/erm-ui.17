...
export class InvoiceComponent implements OnInit {
  ...
  trackId = (_index: number, item: Invoice): number => this.invoiceService.getInvoiceIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: Invoice[] | null): Invoice[] {
    return data ?? [];
  }
