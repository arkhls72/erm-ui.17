...
describe('Invoice Service', () => {
  ...
  let expectedResult: Invoice | Invoice[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addInvoiceToCollectionIfMissing', () => {
      it('should add a Invoice to an empty array', () => {
        const invoice: Invoice = sampleWithRequiredData;
      ...
      it('should not add a Invoice to an array that contains it', () => {
        const invoice: Invoice = sampleWithRequiredData;
        const invoiceCollection: Invoice[] = [
          {
            ...invoice,
          },
      ...
      it("should add a Invoice to an array that doesn't contain it", () => {
        const invoice: Invoice = sampleWithRequiredData;
        const invoiceCollection: Invoice[] = [sampleWithPartialData];
        expectedResult = service.addInvoiceToCollectionIfMissing(invoiceCollection, invoice);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(invoice);
      });
      ...
      it('should add only unique Invoice to an array', () => {
        const invoiceArray: Invoice[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const invoiceCollection: Invoice[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const invoice: Invoice = sampleWithRequiredData;
        const invoice2: Invoice = sampleWithPartialData;
