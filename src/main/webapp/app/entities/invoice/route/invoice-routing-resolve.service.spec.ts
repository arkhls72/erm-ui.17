...
describe('Invoice routing resolve service', () => {
  ...
  let resultInvoice: Invoice | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Invoice returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Invoice>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
