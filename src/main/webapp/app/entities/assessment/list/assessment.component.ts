...
import { EntityArrayResponseType, AssessmentService } from '../service/assessment.service';
...
export class AssessmentComponent implements OnInit {
  ...
  trackId = (_index: number, item: Assessment): number => this.assessmentService.getAssessmentIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.assessments = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: Assessment[] | null): Assessment[] {
    return data ?? [];
  }
