...
describe('Assessment Service', () => {
  ...
  let expectedResult: Assessment | Assessment[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addAssessmentToCollectionIfMissing', () => {
      it('should add a Assessment to an empty array', () => {
        const assessment: Assessment = sampleWithRequiredData;
      ...
      it("should add a Assessment to an array that doesn't contain it", () => {
        const assessment: Assessment = sampleWithRequiredData;
        const assessmentCollection: Assessment[] = [sampleWithPartialData];
        expectedResult = service.addAssessmentToCollectionIfMissing(assessmentCollection, assessment);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(assessment);
      });
      ...
      it('should add only unique Assessment to an array', () => {
        const assessmentArray: Assessment[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const assessmentCollection: Assessment[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const assessment: Assessment = sampleWithRequiredData;
        const assessment2: Assessment = sampleWithPartialData;
