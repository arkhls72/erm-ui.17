...
describe('Assessment routing resolve service', () => {
  ...
  let resultAssessment: Assessment | null | undefined;
  ...
  describe('resolve', () => {
    it('should return Assessment returned by find', () => {
      // GIVEN
    ...
    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<Assessment>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
