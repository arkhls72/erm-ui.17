...
export class MedicationComponent implements OnInit {
  ...
  trackId = (_index: number, item: Medication): number => this.medicationService.getMedicationIdentifier(item);
  ...
  protected refineData(data: Medication[]): Medication[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: Medication[] | null): Medication[] {
    return data ?? [];
  }
