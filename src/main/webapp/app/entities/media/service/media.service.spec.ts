...
describe('Media Service', () => {
  ...
  let expectedResult: Media | Media[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addMediaToCollectionIfMissing', () => {
      it('should add a Media to an empty array', () => {
        const media: Media = sampleWithRequiredData;
      ...
      it("should add a Media to an array that doesn't contain it", () => {
        const media: Media = sampleWithRequiredData;
        const mediaCollection: Media[] = [sampleWithPartialData];
        expectedResult = service.addMediaToCollectionIfMissing(mediaCollection, media);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(media);
      });
      ...
      it('should add only unique Media to an array', () => {
        const mediaArray: Media[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const mediaCollection: Media[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const media: Media = sampleWithRequiredData;
        const media2: Media = sampleWithPartialData;
