...
describe('Media Management Detail Component', () => {
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [MediaDetailComponent, RouterTestingModule.withRoutes([], { bindToComponentInputs: true })],
      providers: [
        provideRouter(
          [
            {
  ...
  describe('OnInit', () => {
    it('Should load media on init', async () => {
      ...
      // THEN
      expect(instance.media).toEqual(expect.objectContaining({ id: 123 }));
    });
  });
