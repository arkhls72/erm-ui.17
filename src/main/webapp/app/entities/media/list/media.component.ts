...
export class MediaComponent implements OnInit {
  ...
  trackId = (_index: number, item: Media): number => this.mediaService.getMediaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.media = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: Media[] | null): Media[] {
    return data ?? [];
  }
