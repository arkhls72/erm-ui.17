...
describe('Supplier Service', () => {
  ...
  let expectedResult: Supplier | Supplier[] | boolean | null;
  ...
  describe('Service methods', () => {
    ...
    describe('addSupplierToCollectionIfMissing', () => {
      it('should add a Supplier to an empty array', () => {
        const supplier: Supplier = sampleWithRequiredData;
      ...
      it('should not add a Supplier to an array that contains it', () => {
        const supplier: Supplier = sampleWithRequiredData;
        const supplierCollection: Supplier[] = [
          {
            ...supplier,
          },
      ...
      it("should add a Supplier to an array that doesn't contain it", () => {
        const supplier: Supplier = sampleWithRequiredData;
        const supplierCollection: Supplier[] = [sampleWithPartialData];
        expectedResult = service.addSupplierToCollectionIfMissing(supplierCollection, supplier);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(supplier);
      });
      ...
      it('should add only unique Supplier to an array', () => {
        const supplierArray: Supplier[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const supplierCollection: Supplier[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const supplier: Supplier = sampleWithRequiredData;
        const supplier2: Supplier = sampleWithPartialData;
