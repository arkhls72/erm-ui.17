...
export class SupplierComponent implements OnInit {
  ...
  trackId = (_index: number, item: Supplier): number => this.supplierService.getSupplierIdentifier(item);
  ...
  protected fillComponentAttributesFromResponseBody(data: Supplier[] | null): Supplier[] {
    return data ?? [];
  }
